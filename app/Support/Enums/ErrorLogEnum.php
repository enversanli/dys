...
enum ErrorLogEnum:string
{
    ...
    // Daily Attendances
    case GET_DAILY_ATTENDANCES_REPOSITORY_ERROR = 'GET_DAILY_ATTENDANCES_REPOSITORY_ERROR';
    case STORE_DAILY_ATTENDANCES_REPOSITORY_ERROR = 'STORE_DAILY_ATTENDANCES_REPOSITORY_ERROR';
}
